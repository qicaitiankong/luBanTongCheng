...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self){
        ...
        //
        self.commissionLabel = [[CustomeLzhLabel alloc]initWithCustomerParamer:[UIFont getPingFangSCBold:60] titleColor:[UIColor colorWithHexString:@"#333333"] aligement:1];
