...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.pencilImageView.center = CGPointMake(self.pencilImageView.centerX, frame.size.height / 2);
        ...
        self.rightTipLabel.frame = CGRectMake(self.pencilImageView.right + 8, 0, frame.size.width - self.pencilImageView.right, frame.size.height);
